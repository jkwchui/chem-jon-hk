...
[Download narrated Powerpoint](/resources/slides/4-ionic_bonds.pptx).  This is the recommended way if you have desktop Powerpoint app. You can control the progress and timing of the slides as well as switching on subtitles.
...
<Subsubtopic id='4.1.G1' type='Guidance' content='Students should be familiar with the names of these polyatomic ions: ammonia, hydroxide, nitrate, (bi/hydrogen)carbonate, carbonate, sulphate, phosphate.' />
