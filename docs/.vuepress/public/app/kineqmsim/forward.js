...
// --- CONFIGURATION -------------------------------------
  ...
  var forwardConditions = 1 // when die should flip
  var backwardConditions = 0 // when die should flip back
...
function setup() {
  ...
  // gui.parent('GUIpanel')
  gui.addGlobals('dieCount', 'initialRemain', 'dieSide', 'forwardConditions', 'MYSTERY')
