...
.puzzle
  task(
    ...
    template(v-slot:reflect='')
      p Drawing just one atom can take awhile.
      p Even if a robot can draw it for us, it's still tedious to count all the purple and gray circles.
      p What can we do to simplify this?
