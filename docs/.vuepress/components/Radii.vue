...
export default {
      ...
      return {
        ...
        legend: {
            ...
            selected: {
              ...
              'atomic radii': this.atomic,
              'ionic radii': this.ionic
            }
        },
        dataZoom: [{
            type: 'inside',
        ...
        series: [
            ...
            },
            {
                ...
                type: 'line',
                step: 'middle',
                data: this.loadIonicRadii(),
                // charge: this.loadIonCharge(),
                color: ['#983e09'],
                yAxisIndex: 1
            }
        ]
  ...
  methods: {
    ...
    loadIonicRadiiAndCharge: function () {
      var ion_prop = [
        ['ionic radii', 'charge']
      ]
      ...
      for (var i = 0; i < arrayLength; i++) {
          // console.log(myStringArray[i]);
          ion_prop.push([this.data[i].ionic_radii, this.data[i].ion])
      }
      return ion_prop
    },

    loadIonicRadii: function () {
      var ionic_radiis = []

      var arrayLength = this.data.length;
      for (var i = 0; i < arrayLength; i++) {
          // console.log(myStringArray[i]);
          ionic_radiis.push(this.data[i].ionic_radii)
      }
      return ionic_radiis
    },

    loadIonCharge: function () {
      var charges = []

      var arrayLength = this.data.length;
      for (var i = 0; i < arrayLength; i++) {
          // console.log(myStringArray[i]);
          charges.push(this.data[i].ion)
      }
      return charges
    }
  }
