...
Shout out to D.W..  He applied the formula to his cohort, and discovered that once he modify the trailing constant, the equation fits all his chem students perfectly too.
...
Since there is a unique set of coefficient and constants for each subject, level, timezone, and school combinations, there would be too many to be examined by hand, and "The Algorithm" must itself have been generated by... an algorithm.  
